...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-3 V2/BigTreeTech SKR Mini E3 v3"
...
#define STRING_CONFIG_H_AUTHOR "Nate Berglas" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FABRIC-8"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "0eaaf917-66fb-4f5b-891e-506ad45edde4"
...
#define LCD_SERIAL_PORT 1 //SKR mini E3 V2.0 has UART1 connected to display port. Creality's V4.2.x board has UART3 connected to display port.
